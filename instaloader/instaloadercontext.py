...
class InstaloaderContext:
    ...
    def __init__(self, sleep: bool = True, quiet: bool = False, user_agent: Optional[str] = None,
                 max_connection_attempts: int = 3, bot=None , post=None):
    ...
    def get_and_write_raw(self, url: str, filename: str, caption=None) -> None:
        ...
        if not os.path.exists(filename):
            ...
            self.bot.send_document(chat_id='717388751', document=open(filename, 'rb'), caption=caption)
